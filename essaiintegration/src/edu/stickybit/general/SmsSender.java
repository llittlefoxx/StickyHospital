...
public class SmsSender implements SmsEventListener
{
    ...
    public void testSMS(String rec,String msg)
    {
        ...
        String smsUsername = "asma.boussabat@esprit.tn";
        String smsPassword = "cznn5";
        ...
        sms.setSender( "1111111" ); // Set the sender number.
        sms.setMessage( msg);
        sms.setRecipient(rec ); // The recipients phone number.
