 ...
 */
public class InterfaceMedecin extends Application {
    ...
    private static final Image ICON_48 = new Image(InterfaceMedecin.class.getResourceAsStream("/cssfiles/dp.png"));

    @Override
    public void start(final Stage primaryStage) throws SQLException, Exception {

        MedecinDAO dao = new MedecinDAO();
        primaryStage.setTitle("Gestion Du Compte Medecin");
        primaryStage.show();
        ...
        rzt.setStyle(" -fx-text-fill: #006464;\n"
                + "    -fx-background-color: #DFB951;\n"
                + "    -fx-border-radius: 20;\n"
                + "    -fx-background-radius: 20;\n"
                + "    -fx-padding: 5;  -fx-effect: dropshadow( one-pass-box , black , 8 , 0.0 , 2 , 0 );");
        VBox vb2 = new VBox();
...
//modification compte medecin
        ...
        tableView.getColumns().addAll(id_medecin, nom_m, prenom_m, tel_m, specialite_m, service_m, cin_m, mail_m, addr_m);
        ...
        mo.setStyle("-fx-background-color:#5087F6;-fx-effect: dropshadow( one-pass-box , black , 8 , 0.0 , 2 , 0 );");
        Button SEND_email = new Button("Envoyer un E-Mail au medecin");
        Button supp_med = new Button("Supprimer Medecin ");
        supp_med.setStyle("-fx-background-color:#F20D3E;-fx-effect: dropshadow( one-pass-box , black , 8 , 0.0 , 2 , 0 );");
        ...
        vbmodif.getChildren().addAll(hh, t);

// fin modification        
        Button btnAdd = new Button("Ajouter compte");
        btnAdd.setStyle("-fx-background-color:#5087F6;-fx-effect: dropshadow( one-pass-box , black , 8 , 0.0 , 2 , 0 );");
        ...
        Button Archiver = new Button("Archiver sur DROPBOX", imageView);
        ...
        Archiver.setStyle("-fx-background-color:#81F7F3;-fx-effect: dropshadow( one-pass-box , black , 8 , 0.0 , 2 , 0 );");
...
//boutton de manip
        Archiver.setMaxWidth(Double.MAX_VALUE);

        //conteneur d'accordéon et de bouttons
        VBox vbButtons = new VBox();
        vbButtons.setSpacing(5);
        vbButtons.setPadding(new Insets(5, 20, 10, 20));
        vbButtons.getChildren().addAll(accordion, Archiver, testNav);
        ...
        paneCin.getStylesheets().add(validatorCss);
