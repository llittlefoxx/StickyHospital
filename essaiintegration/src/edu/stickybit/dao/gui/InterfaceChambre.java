...
/**
 *
 * @author Manel Rhaiem <manel.rhaiematesprit.tn>
 */
public class InterfaceChambre extends Application {
List<Lit> listeLits;
...
//                    final Object valCh = tablePosition.getTableColumn().getCellData(t1);
       ...
       final  TableColumn etatm = new TableColumn("Etat");
            ...
            public void changed(ObservableValue observableValue, Object oldValue, Object newValue) {
                if (tableViewmSupp.getSelectionModel().getSelectedItem() != null) {
                   ...
                   final Object valCh = tablePosition.getTableColumn().getCellData(newValue);
                    ...
                    children(new Text(" voulez vous supprimer cet chambre\t" + valCh), supp_chambre).alignment(Pos.CENTER).padding(new Insets(5)).build()));
                    supp_chambre.setOnAction(new EventHandler<ActionEvent>() {
                        @Override
                        public void handle(ActionEvent event) {
                            String val = valCh.toString();
                            daoChambre2.deleteChambre(Integer.parseInt(val));
        ...
        primaryStage.setTitle("Gestion Chambre");
