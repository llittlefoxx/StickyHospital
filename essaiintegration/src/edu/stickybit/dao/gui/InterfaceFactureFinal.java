 ...
 */
public class InterfaceFactureFinal {

    public InterfaceFactureFinal() {
    }
    ...
    List<Intervention> arrayInter = new ArrayList<>();
...
//        stage.setTitle("Gestion des factures");
        ...
        arrayFact = daoFact.DisplayAllFactures();
        ...
        idfactureCol.setCellValueFactory(new PropertyValueFactory<Facture, String>("id_facture"));

        TableColumn idpatientCol = new TableColumn("Id Patient");
        idpatientCol.setMinWidth(100);
        idpatientCol.setCellValueFactory(new PropertyValueFactory<Facture, String>("id_patient"));

        TableColumn idadminCol = new TableColumn("Id Admin");
        idadminCol.setMinWidth(100);
        idadminCol.setCellValueFactory(new PropertyValueFactory<Facture, String>("id_dadmin"));

        TableColumn dateCol = new TableColumn("Date Facturation");
        dateCol.setMinWidth(150);
        dateCol.setCellValueFactory(new PropertyValueFactory<Facture, String>("date_facturation"));
        ...
        rech.setGraphic(new ImageView(im_search));
        rech.setStyle("-fx-background-color: transparent;");
        ...
        act.setGraphic(new ImageView(im_refresh));
        act.setStyle("-fx-background-color: transparent;");
        ...
        Button modiffact = new Button("Modifier facture");
        modiffact.setCursor(Cursor.HAND);
        modiffact.getStylesheets().add(styleback);
        modiffact.setId("rich-blue");

        Button ImprFact = new Button("Imprimer la facture");
        ImprFact.setCursor(Cursor.HAND);
        Image im_imp = new Image(getClass().getResourceAsStream("/cssfiles/Printer.png"));
        ImprFact.setGraphic(new ImageView(im_imp));
        ImprFact.setStyle("-fx-background-color: transparent;");
        ...
        ImprFact.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent t) {

               ReportController rc = new ReportController(factid, fact_id_pat);
            }
        });
        modiffact.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent t) {
                ...
                remed.setCursor(Cursor.HAND);
                Image im_search = new Image(getClass().getResourceAsStream("/cssfiles/search.png"));
                remed.setGraphic(new ImageView(im_search));
                remed.setStyle("-fx-background-color: transparent;");
                ...
                rin.setCursor(Cursor.HAND);
                Image im_search2 = new Image(getClass().getResourceAsStream("/cssfiles/search.png"));
                rin.setGraphic(new ImageView(im_search2));
                rin.setStyle("-fx-background-color: transparent;");
                ...
                addL.getStylesheets().add(styleback);
                addL.setId("rich-blue");
                    ...
                    public void handle(ActionEvent actionEvent) {
                        try {
                            if (Integer.valueOf(txt_choix_quan.getText()) > qm) {
                                ...
                                //  Dialogs.showErrorDialog(stage, "Quantité trop grande !", "Error Dialog", "Erreur");
                                txt_choix_med.clear();
                                txt_choix_int.clear();
                ...
                addI.getStylesheets().add(styleback);
                addI.setId("rich-blue");
                ...
                calcul.setCursor(Cursor.HAND);
                calcul.getStylesheets().add(styleback);
                calcul.setId("rich-blue");
                calcul.setOnAction((new EventHandler<ActionEvent>() {
                    ...
                    public void handle(ActionEvent actionEvent) {
                        ...
                        try {
                            ...
                            for (LigneFacture arrayLigne1 : arrayLigne) {
                                total += arrayLigne1.getPrix() * arrayLigne1.getQuantite();
                            }
                ...
                caltva.setCursor(Cursor.HAND);
                caltva.getStylesheets().add(styleback);
                caltva.setId("rich-blue");
                ...
                tva.getChildren().addAll(caltva, tva_tx, ImprFact);
        ...
        aj.setCursor(Cursor.HAND);
        aj.getStylesheets().add(styleback);
        aj.setId("rich-blue");
        ...
        aj.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent t) {
                ...
                remed.setCursor(Cursor.HAND);
                remed.getStylesheets().add(styleback);
                remed.setId("rich-blue");
                remed.setOnAction((new EventHandler<ActionEvent>() {
                    @Override
                    public void handle(ActionEvent actionEvent) {
                ...
                final Button actu = new Button();
                actu.setText("Actualiser");
                actu.setCursor(Cursor.HAND);
                actu.getStylesheets().add(styleback);
                actu.setId("rich-blue");
                ...
                rin.setText("Rechercher");
                rin.setCursor(Cursor.HAND);
                rin.getStylesheets().add(styleback);
                rin.setId("rich-blue");
                rin.setOnAction((new EventHandler<ActionEvent>() {
                    @Override
                    public void handle(ActionEvent actionEvent) {
       ...
       // A.getPanes().addAll(t1);
        ...
        Image im_f = new Image(getClass().getResourceAsStream("/cssfiles/facture.png"));
        fact.setGraphic(new ImageView(im_f));
        fact.setStyle("-fx-background-color: transparent;");
        Tooltip toolB_aj = new Tooltip("Créer et gérer facturation");
        toolB_aj.setContentDisplay(ContentDisplay.BOTTOM);
        toolB_aj.setStyle("");
        fact.setTooltip(toolB_aj);

        //borderpane boutons+interface à droite
        BorderPane bord_fact = new BorderPane();
        bord_fact.setLeft(fact);
        bord_fact.setCenter(vbox);
